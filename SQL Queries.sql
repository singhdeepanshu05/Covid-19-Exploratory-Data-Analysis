...
Round((Cast([state_total_vaccinated_2] as float)/Cast([state_total_population] as float)),4)*100 as [ Vaccinated2_%] from  (select s.state as state_name,s.state_short,s.state_total_population,t.total_confirmed as state_total_confirmed,s.state_total_deceased,s.state_total_recovered,s.state_total_tested
